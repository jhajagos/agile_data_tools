...
class TestGetColumnsThatRepeatFromDatabase(unittest.TestCase):
    def setUp(self):
        ...
        self.connection.execute("create table denormalized_table (id integer, date_of_service date, dx1 varchar(8), dx2 varchar(8), dx3 varchar(8));")

        self.connection.execute("insert into denormalized_table (id, date_of_service, dx1) values (1, '2012-01-01','250.00')")
        self.connection.execute("insert into denormalized_table (id, date_of_service, dx1, dx2) values (5, '2012-01-01','250.00','401.00')")
        self.connection.execute("insert into denormalized_table (id, date_of_service, dx1, dx2, dx3) values (11, '2012-01-01','250.00','250.01','401.00')")
    ...
    def test_get_column_names(self):
        ...
        self.assertEquals(["id", "date_of_service", "dx1", "dx2", "dx3"], column_names)
...
class TestGetColumnsThatAppearToRepeat(unittest.TestCase):
    ...
    def test_identify_columns_that_repeat(self):
        ...
        import pprint
        pprint.pprint(columns_that_repeat1)
